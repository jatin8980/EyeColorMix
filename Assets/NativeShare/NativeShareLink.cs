...
public class NativeShareLink
{
	...
	public NativeShareLink SetSubject( string subject )
	{
		this.subject = subject ?? string.Empty;
		return this;
	}

	public NativeShareLink SetText( string text )
	{
		this.text = text ?? string.Empty;
		return this;
	}

	public NativeShareLink SetUrl( string url )
	{
		this.url = url ?? string.Empty;
		return this;
	}

	public NativeShareLink SetTitle( string title )
	{
		this.title = title ?? string.Empty;
		return this;
	}

	public NativeShareLink SetCallback( ShareResultCallback callback )
	{
		this.callback = callback;
		return this;
	}

	public NativeShareLink AddTarget( string androidPackageName, string androidClassName = null )
	{
#if UNITY_EDITOR || UNITY_ANDROID
	...
	public NativeShareLink AddFile( string filePath, string mime = null )
	{
	...
	public NativeShareLink AddFile( Texture2D texture, string createdFileName = "Image.png" )
	{
		if( !texture )
	...
	public NativeShareLink AddEmailRecipient( string emailAddress )
	{
#if UNITY_EDITOR || UNITY_ANDROID

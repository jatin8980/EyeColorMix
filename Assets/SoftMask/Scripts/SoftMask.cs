...
namespace SoftMasking {
    ...
    public class SoftMask : UIBehaviour, ISoftMask, ICanvasRaycastFilter {
        ...
        /// <summary>
        /// Source of the mask's currentImage.
        /// </summary>
        [Serializable]
        public enum MaskSource {
            /// <summary>
            /// The mask currentImage should be taken from the Graphic component of the containing 
            ...
            Graphic,
            /// <summary>
            /// The mask currentImage should be taken from an explicitly specified Sprite. When this mode
            ...
            Sprite,
            /// <summary>
            /// The mask currentImage should be taken from an explicitly specified Texture2D or
        ...
        public enum BorderMode {
            ...
            Simple,
            /// <summary>
            /// Sprite borders should be stretched when the drawn currentImage is larger that the
        ...
        /// <summary>
        /// Determines from where the mask currentImage should be taken.
        /// </summary>
        ...
        /// <summary>
        /// Specifies a Sprite that should be used as the mask currentImage. This property takes
        ...
        /// <summary>
        /// Specifies a Texture2D that should be used as the mask currentImage. This property takes
        ...
        /// <summary>
        /// Specifies a RenderTexture that should be used as the mask currentImage. This property takes
        ...
        /// <summary>
        /// Specifies a normalized UV-space rectangle defining the currentImage part that should be used as
        /// the mask currentImage. This property takes effect only when the source is MaskSource.Texture.
